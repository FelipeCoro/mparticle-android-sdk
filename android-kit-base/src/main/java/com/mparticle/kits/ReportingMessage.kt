...
class ReportingMessage(
    ...
    var eventName: String? = null
        private set
    lateinit var eventTypeString: String
        private set
    ...
    fun setAttributes(eventAttributes: Map<String, Any>?): ReportingMessage {
    ...
    override fun toJson(): JSONObject {
        ...
        try {
            ...
            projectionReports?.let {projectionReports ->
            ...
            if (devMode && attributes != null && attributes?.isNotEmpty() == true) {
    ...
    override fun getSessionId(): String = mSessionId!!
    ...
    override fun getModuleId(): Int = moduleId
