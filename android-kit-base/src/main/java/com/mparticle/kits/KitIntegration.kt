...
abstract class KitIntegration {
    ...
    fun setKitConfiguration(configuration: KitConfiguration?): KitIntegration {
        ...
        get() {
            ...
            if (instance != null) {
                ...
                if (user != null) {
                    ...
                    val attributes = filterAttributes(
                    ...
                    return if (this is AttributeListener && (this as AttributeListener).supportsAttributeLists()) {
                        ...
                        for ((key, value) in attributes) {
                            if (value is List<*>) {
                                attributes[key] = KitUtils.join(value as MutableList<String>)
                            }
                        }
                        attributes
                    }
    ...
    open fun logMPEvent(baseEvent: MPEvent): List<ReportingMessage?>? {
    ...
    protected val integrationAttributes: Map<String, String>?
         get() = kitManager!!.getIntegrationAttributes(this)
     ...
     * @param settings
     */
    fun onSettingsUpdated(settings: java.util.HashMap<String, String>) {}
